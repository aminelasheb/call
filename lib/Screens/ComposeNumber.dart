...
class _ComposeNumberState extends State<ComposeNumber> {
    ...
    return Scaffold(
      ...
      body: Container(
        margin: EdgeInsets.symmetric(
            vertical: sizee.height * 0.04, horizontal: sizee.width * 0.04),
        padding: EdgeInsets.symmetric(
            vertical: sizee.height * 0.02, horizontal: sizee.width * 0.02),
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    Provider.of<Infos>(context, listen: false).Number,
                    style: TextStyle(
              ...
              Provider.of<Infos>(context, listen: false).Number == ""
                  ? Container(height: sizee.height * 0.06)
                  : Container(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      onTap: () {
                        Provider.of<Infos>(context, listen: false).onlong = 900;
                    ...
                    InkWell(
                      onTap: () {
                        setState(() {
                          Provider.of<Infos>(context, listen: false).DelNum();
                        });
                      },
                      child: Container(
                        decoration: BoxDecoration(
  ...
  GestureDetector num(Size sizee, String numb, String ABC) {
    return GestureDetector(
      onTap: () {
        setState(() {
          Provider.of<Infos>(context, listen: false).AddNum(numb);
        });
      },
      onLongPressUp: () {
        if (numb == "0") {
          setState(() {
            Provider.of<Infos>(context, listen: false).AddNum("+");
          });
        }
      },
      child: Container(
